...
class FindingCode(Enum):
    ...
    DEFAULT_OUTBOUND_ACCESS_DISABLED = "DEFAULT_OUTBOUND_ACCESS_DISABLED"
    OUTBOUND_TYPE_NONE = "OUTBOUND_TYPE_NONE"
    OUTBOUND_TYPE_BLOCK = "OUTBOUND_TYPE_BLOCK"
    OUTBOUND_TYPE_UNSUPPORTED = "OUTBOUND_TYPE_UNSUPPORTED"
    BOOTSTRAP_ACR_MISSING = "BOOTSTRAP_ACR_MISSING"
    BOOTSTRAP_ACR_DNS_NOT_LINKED = "BOOTSTRAP_ACR_DNS_NOT_LINKED"
    PROXY_NOT_REACHABLE = "PROXY_NOT_REACHABLE"
    HTTP_PROXY_CONFIGURED = "HTTP_PROXY_CONFIGURED"
    SERVICE_TAG_IN_AUTH_RANGES = "SERVICE_TAG_IN_AUTH_RANGES"
    SERVICE_TAG_VNET_INTEGRATION_CONFLICT = "SERVICE_TAG_VNET_INTEGRATION_CONFLICT"
    NAP_ENABLED = "NAP_ENABLED"
    NAP_SUBNET_NOT_ANALYZED = "NAP_SUBNET_NOT_ANALYZED"
